...
import { makeList, FIXTURE_HOUSEHOLD_ID } from '../contract/fixtures/hasura-fixtures';

describe('ListStore transitions', () => {
  it('loads lists and auto-selects first list', async () => {
    const repository = {
      getLists: vi.fn(async () => [makeList(), makeList({ id: '44444444-4444-4444-4444-444444444444', sortOrder: 1, title: 'School' })]),
      createList: vi.fn(),
      deleteList: vi.fn()
    };
  ...
  it('creates a list and selects the created list', async () => {
    const created = makeList({ id: '55555555-5555-5555-5555-555555555555', title: 'Chores', sortOrder: 1 });
    const repository = {
  ...
  it('deletes selected list and falls back to first remaining list', async () => {
    const a = makeList({ id: 'aaaaaaa1-1111-1111-1111-111111111111', title: 'A', sortOrder: 0 });
    const b = makeList({ id: 'bbbbbbb2-2222-2222-2222-222222222222', title: 'B', sortOrder: 1 });
