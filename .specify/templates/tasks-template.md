...
**Tests**: Test tasks are REQUIRED. Every user story and behavior change MUST include
appropriate automated coverage per the constitution.
...
- [ ] T004 [P] Configure automated test tooling and CI test execution
- [ ] T005 [P] Define accessibility checks/tooling for affected user interfaces
...
- [ ] T012 Document and approve any new dependency additions with alternatives considered
...
- [ ] T021 [US1] Verify accessibility criteria for changed UI in this story
...
- [ ] T028 [US2] Verify accessibility criteria for changed UI in this story
...
- [ ] T034 [US3] Verify accessibility criteria for changed UI in this story
...
- [ ] TXXX Dependency pruning (remove unused/transitive bloat)
- [ ] TXXX UX simplification pass for primary user journeys
